...
impl Topic {
    ...
    pub fn canonical(&self) -> String {
        match self {
            ...
            Topic::Worked => "logbook/worked".to_string(),
            ...
            Topic::TxLog(id) => format!("radio/{}/tx_log", id.0),
            Topic::Interlock(id) => format!("radio/{}/interlock", id.0),
            ...
            Topic::BandStatus => "band/status".to_string(),
    ...
    pub fn parse(s: &str) -> Result<Topic, BusError> {
        ...
        let topic = match parts.as_slice() {
            ...
            ["radio", id, "tx_log"] => Topic::TxLog(RadioId(id.to_string())),
            ["radio", id, "interlock"] => Topic::Interlock(RadioId(id.to_string())),
    ...
    pub fn kind(&self) -> TopicKind {
        match self {
            ...
            Topic::TxLog(_) => TopicKind::TxLog,
            Topic::Interlock(_) => TopicKind::Interlock,
            ...
            Topic::BandStatus => TopicKind::BandStatus,
...
impl TopicKind {
    ...
    pub fn delivery_class(&self) -> DeliveryClass {
        ...
        match self {
            ...
            TopicKind::TxLog => StreamLossless,
            TopicKind::Worked => State,
...
mod tests {
    ...
    fn topic_round_trip_and_class() {
        ...
        let cases = [
            ...
            (Topic::Worked, DeliveryClass::State),
            ...
            (Topic::TxLog(r()), DeliveryClass::StreamLossless),
            (Topic::Interlock(r()), DeliveryClass::Command),
            ...
            (Topic::BandStatus, DeliveryClass::State),
