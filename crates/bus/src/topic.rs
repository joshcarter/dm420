...
impl Topic {
    ...
    pub fn canonical(&self) -> String {
        match self {
            ...
            Topic::Worked(id) => format!("radio/{}/worked", id.0),
    ...
    pub fn parse(s: &str) -> Result<Topic, BusError> {
        ...
        let topic = match parts.as_slice() {
            ...
            ["radio", id, "worked"] => Topic::Worked(RadioId(id.to_string())),
    ...
    pub fn kind(&self) -> TopicKind {
        match self {
            ...
            Topic::Worked(_) => TopicKind::Worked,
...
mod tests {
    ...
    fn topic_round_trip_and_class() {
        ...
        let cases = [
            ...
            (Topic::Worked(r()), DeliveryClass::State),
